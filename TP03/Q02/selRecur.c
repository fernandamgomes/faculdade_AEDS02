...
void selecaoRecur(Filme filmes[], int contador, int i);
...
int main(void)
{
    ...
    selecaoRecur(filmes, contador, 0);
...
void selecaoRecur(Filme filmes[], int contador, int i)
{
    ...
    {
        int resultado = strcmp(filmes[min].titulo, filmes[j].titulo);
        if (resultado > 0)
        {
            min = j;
        }
    ...
    if (i++ < contador)
    {
        selecaoRecur(filmes, contador, i++);
    }
}
